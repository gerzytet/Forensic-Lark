...
then
    ...
    then
        ...
        then
            echo "good job!"
            echo "2" > "$progress"
            echo "To make future work easier, you can use piping to send the output of the command directly to another command (including hq) without typing it in again."
            echo "To send the line count of the customer datavase straight to hq, use this command:"
            echo "cat ./customer_db.txt | wc -l | hq"
            ...
            echo "Remember: use hq (number) to send this information to us"
        fi
    ...
    then
        ...
        then
            ...
            echo "cat the database | uniq | line count | hq"
        fi
